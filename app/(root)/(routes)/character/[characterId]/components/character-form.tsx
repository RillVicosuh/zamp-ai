...
The form will require a name, description, instructions, seed, image, and category

The message variable is what will display if the user does not input the values correctly
*/
...
//This Character form retrieves the categories in the database and the initial data of a character if it has already been created
export const CharacterForm = ({
    categories,
    initialData
}: CharacterFormProps) => {
    //Using toast for error handling
    const { toast } = useToast();
    const router = useRouter();

    //The form is initialized with either default empty values or the values of the A.I. character that has already been created
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            if (initialData) {
                ...
                //This will pass the values of the form and create the character in the database
    ...
    //Creating the form interface for submitting the image, name, description, category, instructions, and seed
    return (
                    ...
                    <div className="space-y-2 w-full col-span-2">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                General information about your A.I. Character
                            </p>
                        </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Short description for your A.I. Character
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
